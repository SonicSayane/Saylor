...
# Default store/site name used in templates and emails.
# You can override it by setting the `SITE_NAME` environment variable.
SITE_NAME = os.environ.get("SITE_NAME", "Saylor")
